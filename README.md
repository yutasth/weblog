...
同じ日の記事をまとめた日別ページ`/20260609/`も自動生成されます。カレンダーの日付はこの日別ページへリンクします。
...
月別ページと日別ページは`_plugins/archive_pages_generator.rb`が日記ファイルから自動生成します。
